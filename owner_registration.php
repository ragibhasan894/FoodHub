                ...
                <!-- Nested Row Starts -->
                    ...
                    <!-- Register Col Starts -->
                        <div class="col-md-5 col-xs-12 col-md-offset-2">
                            <h4 class="text-spl-color">Login for first time Owner?</h4>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content no-boxshadow text-center">
					...
					<!-- Register Form Starts -->
						<form action="view/restaurant/reg.php" method="post">
							<div class="form-group">
								<label class="sr-only" for="register-fname">Restaurant Name</label>
								<input name="restaurant_name" type="text" class="form-control" id="register-fname" placeholder="Type Your Restaurant Name">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input name="email" type="email" class="form-control" id="register-email" placeholder="Type Your Email">
							</div>
	
							<div class="form-group">
								<label class="sr-only" for="register-password">Password</label>
								<input name="password" type="password" class="form-control" id="register-password" placeholder="Type Your Password">
							</div>
	
								
							<input name="submit" value="Register" type="submit" class="btn btn-lg btn-block btn-tertiary animation">
